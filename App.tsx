        ...
        <>
          ...
          <main className="relative w-full">
            ...
            */}
            ...
            <div id="experience" className="relative z-[15]">
                <Education />
            </div>

            <div id="news" className="relative z-20">
                <News />
            </div>

            <div id="projects" className="relative z-[25]">
                <Publications />
            </div>

            <div id="more" className="relative z-[35]">
                <MoreAbout />
            </div>

            <div id="internships" className="relative z-40">
                <Internships />
            </div>
